...
function declareView(getPropDefaults, render, getInitialState, private_methods, public_methods) {
    if (getInitialState === void 0) { getInitialState = null; }
    if (private_methods === void 0) { private_methods = null; }
    if (public_methods === void 0) { public_methods = null; }
    var component = {
